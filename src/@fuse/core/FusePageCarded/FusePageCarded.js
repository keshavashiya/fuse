...
const FusePageCarded = React.forwardRef((props, ref) => {
	...
	return (
		<div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
			<div className={props.type && props.hasParent ? classes.topBgAlternate : classes.topBg} />
			...
			<div className="flex container w-full">
				...
				<div
					{... (props.type && props.hasParent ? { style: { backgroundColor: 'white', padding: '0 15px' } } : {})}
					className={clsx(
					...
					<FusePageCardedHeader type={props.type} hasParent={props.hasParent} header={props.header} classes={classes} />
